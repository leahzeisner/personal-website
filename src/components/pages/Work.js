...
function Work({ isLanding = false }) {
  ...
  return (
    <div className="flex flex-col place-items-center bg-yellow">
      <div className="flex flex-col my-32 place-items-center w-screen bg-yellow">
        {!isLanding ? <Header /> : undefined}
        <div className="flex flex-col text-darkblue font-medium w-2/3">
          <header className="text-3xl mb-6 tracking-[.05em]">
            My Work Experience
          </header>
          <hr className="h-px mb-6 bg-pink border-0"></hr>
          ...
          <ol className="relative border-s border-darkblue">
            <li className="mb-10 ms-4">
              ...
              <ul className="my-2 text-base list-disc ml-8 font-medium hidden">
                ...
                <li>
                  Demonstrated efficiency in meeting client deadlines and
                  delivering a functional product for their research project.
                </li>
                <li>
                  Demoed the product to the entire C4C club to show the
                  product’s development over time.
                </li>
              </ul>
              {/* <a
            href="#"
          ...
          >
            ...
            <li className="mb-10 ms-4">
              ...
              <ul className="my-2 text-base list-disc ml-8 font-medium hidden">
                ...
                <li>
                  Upgraded major features including how tutors schedule
                  meetings.
                </li>
                <li>
            ...
            <li className="mb-10 ms-4">
              ...
              <ul className="my-2 text-base list-disc ml-8 font-medium hidden">
                ...
                <li>
                  Familiarized myself with popular technologies, including
                  GraphQL and AWS, broadening my involvement in the development
                  process.
                </li>
                <li>
                  Collaborated with global cross-functional teams to
                  conceptualize, design, and implement new features while
                  troubleshooting issues across the entire technology stack.
                </li>
                <li>
                  Integrated our legacy application into a centralized product
                  facilitating user access to data across diverse energy
                  markets, thereby empowering confident investments in clean
                  energy.
                </li>
              </ul>
            </li>
            <li className="mb-10 ms-4">
              ...
              <ul className="my-2 text-base list-disc ml-8 font-medium hidden">
                <li>
                  ...
                  customers and strengthen their first impression of the
                  company.
                </li>
                <li>
                  Reinforced back-end infrastructures through Java & SQL to
                  accommodate various discounting options for WHOOP's product
                  range.
                </li>
                <li>
            ...
            <li className="ms-4">
              ...
              <ul className="my-2 text-base list-disc ml-8 font-medium hidden">
                ...
                <li>
                  Adapted to a fast-paced, agile work environment in order to
